 ...
 * <ol>
 *   <li>stage_actions WHERE project_id=? AND del_flag='0' ORDER BY id（@TableLogic 自动注入）</li>
 *   <li>deliverables WHERE project_id=? AND del_flag='0' → in-memory 按 action_id groupBy（同上）</li>
 *   <li>join：每个动作的 uploaded 数 = deliverables 里 actionId 命中的条数</li>
 * </ol>
 *
 * <p>[SEC-FIX] 2026-09-06 修复：StageAction/Deliverable entity 已补 delFlag + @TableLogic，
 * MP 自动追加 WHERE del_flag='0'。契约恢复完整。
 *
