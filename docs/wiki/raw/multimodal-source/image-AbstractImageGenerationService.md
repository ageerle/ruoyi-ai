---
source: file:///Users/mac/Documents/ruoyi-ai/ruoyi-modules/ruoyi-chat/src/main/java/org/ruoyi/service/image/AbstractImageGenerationService.java
...
public abstract class AbstractImageGenerationService implements IImageGenerationService {
    ...
    public String generateImage(ImageContext imageContext){
        ...
        return doGenerateImage(chatModelVo, prompt, size, seed, image);
    }
